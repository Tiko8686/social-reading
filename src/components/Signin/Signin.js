...
export function Signin() {
  ...
  const signUp = (data) => {
    if (data.password1 !== data.password2) {
      ...
      axios
        .post("https://socialreading.xyz/auth/users/", {
  ...
  const sendCode = (event) => {
    ...
    console.log(email);
    axios
      .post("https://www.socialreading.xyz/auth/users/reset_password/", {
        email: email.email,
      })
      .then((res) => {
            ...
            <form onSubmit={handleSubmit(signUp)} className="form_style">
              ...
              <div>
                ...
                {errors.first_name &&
                  errors.first_name.type === "maxLength" && (
                    <span>Author name can't be more than 20 characters</span>
                  )}
                {errors.first_name &&
                  errors.first_name.type === "minLength" && (
                    <span>Author name can't be less than 2 characters</span>
                  )}
                {errors.first_name && errors.first_name.type === "pattern" && (
                  <span>Author name can be only letters.</span>
                )}
              </div>
              ...
              <div>
                ...
                {errors.last_name && errors.last_name.type === "pattern" && (
                  <span>Author surname can be only letters.</span>
                )}
              </div>
              ...
              <div className="password_div">
                ...
                {confPasswordErr && (
                  <span>The password and re-enter password doesn't match*</span>
                )}
              </div>
              <div>
