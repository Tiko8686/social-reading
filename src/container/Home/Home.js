              ...
              <div className="post__item" key={e?.id}>
                <div className="post__header">
                  ...
                  <div className="more_div">
                    <button>...</button>
                    {userToken && <div style={{ border: "1px solid red", width: "150px" }}>
                ...
                >
                  {/* {e?.quote_text.length}<br></br> */}
                  {
                    e?.quote_text.length > 400 ? (
                      <>

                        {!lessMore ? <span> {e?.quote_text?.substring(0, 400)}...&nbsp;
                          <button onClick={() => setLessMore(true)}>Show more</button>
                        </span> :
                          <span>{e?.quote_text}&nbsp;<button onClick={() => setLessMore(false)}>Show less</button></span>
                        }
                      </>
                    ) :
